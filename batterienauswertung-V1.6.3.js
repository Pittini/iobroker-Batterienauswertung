// Batterieüberwachungsskript Version 1.6.3 Stand 17.06.2020 - Git: https://github.com/Pittini/iobroker-Batterienauswertung - Forum: https://forum.iobroker.net/topic/31676/vorlage-generische-batteriestandsüberwachung-vis-ausgabe
...
function CheckAllBatterys() { // Prüfung aller Batteriestände bei Skriptstart
    ...
    for (let x = 0; x < Sensor.length; x++) { //Alle Sensoren durchlaufen
        if (SensorState[x] == "dead") {
            if (logging) log("Sensor[" + x + "] = ist ausgefallen oder diconnected");
